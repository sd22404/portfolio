...
export default function Links({className = '', variant = 'text'}: {className?: string, variant?: 'text' | 'button'}) {
    ...
    const emailIcon = (
        <svg className="w-5 h-5 text-accent-quaternary" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
    ...
    const githubIcon = (
        <svg className="w-5 h-5 text-accent-quaternary" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        variant === 'text' ? (
            ...
            <div className={className}>
                <Button href="https://linkedin.com/in/finlay-cooper" variant="ghost">
                    {linkedinIcon}
                </Button>
                <Button href="https://github.com/sd22404" variant="ghost">
                    {githubIcon}
                </Button>
                <Button href="mailto:finlay.j.cooper137@gmail.com" variant="ghost">
                    {emailIcon}
                </Button>
            </div>
        )
